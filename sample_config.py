...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/tipthon/tipthonar"
    )
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/3eb8840e493852131c5eb.jpg"
    )
    ...
    OLDZED_REPO = os.environ.get("OLDZED_REPO", "https://github.com/tipthon/help")
    if OLDZED_REPO and not url(OLDZED_REPO):
        OLDZED_REPO = "https://github.com/tipthon/help"
