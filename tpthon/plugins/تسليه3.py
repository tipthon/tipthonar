# animation3 for zed edit by: @TipThon

# edit by: @TipThon for zedthon
...
@tipthon.ar_cmd(pattern=r"مكعبات$")
async def _(event):
    if event.fwd_from:
        return
...
@tipthon.ar_cmd(pattern=r"deploy$")
async def _(event):
    if event.fwd_from:
        return
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m tpthon`",
...
@tipthon.ar_cmd(pattern=r"تفريغ ?(.*)")
async def _(message):
    if message.fwd_from:
        return
    try:
...
@tipthon.ar_cmd(pattern=r"طائره$")
async def _(event):
    if event.fwd_from:
        return
...
@tipthon.ar_cmd(pattern=r"النضام الشمسي$")
async def _(event):
    if event.fwd_from:
        return
