...
@tipthon.ar_cmd(
    ...
    info={
        "header": "Source code link of TPThon",
        "usage": [
            "{tr}repo",
        ],
    },
...
async def source(e):
    "Source code link of TPThon"
    await edit_or_reply(
        e,
        "Click [here](https://t.me/E9N99) to open this bot source code\
        \nClick [here](https://t.me/E9N99) to open supported link for heroku",
    )
