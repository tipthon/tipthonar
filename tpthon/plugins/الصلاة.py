...
async def get_adzan(adzan):
    ...
    if ZELZAL == "صنعاء" or ZELZAL == "اليمن":
	    ...
	    tipthonresult = f"<b>🕋╎اوقـات الصـلاة بالتـوقيت المحلـي لعواصـم الـدول <b>\
		        ...
		        \n\nᯓ  𝗧𝗶𝗽𝘁𝗵𝗼𝗻 𝗮𝗟 𝗔𝗿𝗮𝗯╎@ E9N99\
	    "
	    await edit_or_reply(adzan, tipthonresult, "html")
