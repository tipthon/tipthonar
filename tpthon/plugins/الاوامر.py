    ...
    if query.startswith("الاوامر") and event.query.user_id == tipthon.uid:
        ...
        if ZEDPIC and ZEDPIC.endswith((".jpg", ".png")):
            result = builder.photo(
                ZEDPIC, title="tipthon", text=Malath, buttons=buttons, link_preview=True
            )
        elif ZEDPIC:
            ...
            result = builder.article(
                title="tipthon", text=Malath, buttons=buttons, link_preview=True
            )
...
async def zed(event):
    await edit_or_reply(
        event,
        "𓆰 [𝗧𝗶𝗽𝘁𝗵𝗼𝗻 𝗮𝗟 𝗔𝗿𝗮𝗯 - اوامــر الخـدمـات الاخـرى](t.me/E9N99) 𓆪\n\n**⎞𝟏⎝** `.التخصيص`\n\n**⎞𝟐⎝**`.الترحيب`\n\n**⎞𝟑⎝** `.الردود`\n\n**⎞𝟒⎝** `.الاذاعه`\n\n**⎞𝟓⎝** `.النشر`\n\n**⎞𝟔⎝** `.الكاشف`\n\n**⎞𝟕⎝** `.ستوريات`\n\n**⎞𝟖⎝** `.التحشيش`\n\n**⎞𝟗⎝** `.المساعد`\n\n**⎞𝟏𝟎⎝** `.الطقس`\n\n\n 𓆩 [𝗧𝗶𝗽𝘁𝗵𝗼𝗻 𝗮𝗟 𝗔𝗿𝗮𝗯](t.me/E9N99) 𓆪",
    )
...
async def zed_handler(tipthon):
    ...
    if query.startswith("تيبثون") and tipthon.query.user_id == bot.uid:
        ...
        buttons = [
            ...
            [
                Button.url("التحـديثـات", "https://t.me/a_aaaf"),
                Button.url("الفـارات", "https://t.me/aa_aaf"),
            ],
            [
                Button.url("الشـروحـات¹", "https://t.me/a_aaaf"),
            ],
            [
                Button.url("الكلايش", "https://t.me/clccca"),
            ],
            [
                Button.url("مطـور السـورس", "https://t.me/M_H_N"),
            ],
        ]
        if ZEDPIC and ZEDPIC.endswith((".jpg", ".png", "gif", "mp4")):
            result = builder.photo(
                ZEDPIC, text=channels, buttons=buttons, link_preview=False
            )
        elif ZEDPIC:
            result = builder.document(
                ZEDPIC,
            ...
            result = builder.article(
                title="tipthon", text=channels, buttons=buttons, link_preview=False
            )
...
async def zed_handler(event):
    ...
    if query.startswith("سورس") and event.query.user_id == tipthon.uid:
        ...
        buttons = [
            [
                Button.url("قنـاة الســورس", "https://t.me/E9N99"),
                Button.url("مطـور الســورس", "https://t.me/M_H_N"),
            ]
        ]
        if ZEDPIC and ZEDPIC.endswith((".jpg", ".png", ".gif", ".mp4")):
            result = builder.photo(
                ZEDPIC, text=Zelzal, buttons=buttons, link_preview=True
            )
        elif ZEDPIC:
            result = builder.document(
                ZEDPIC, title="tipthon", text=Zelzal, buttons=buttons, link_preview=True
            )
        else:
            result = builder.article(
                title="tipthon", text=Zelzal, buttons=buttons, link_preview=True
            )
        await event.answer([result] if result else None)
