...
ZEDPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/1d735babbe8b94cb588ea.jpg"
ZPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/1d735babbe8b94cb588ea.jpg"
...
async def zed_handler(event):
    ...
    if query.startswith("الاوامر") and event.query.user_id == tipthon.uid:
        ...
        if ZEDPIC and ZEDPIC.endswith((".jpg", ".png")):
            result = builder.photo(ZEDPIC,title="tipthon", text=Malath, buttons=buttons, link_preview=True)
        elif ZEDPIC and ZEDPIC.endswith((".mp4")):
            result = builder.document(ZEDPIC,title="tipthon", text=Malath ,buttons=buttons, link_preview=True)
        else:
...
async def zed_handler(tipthon):
    ...
    if query.startswith("تيبثون") and tipthon.query.user_id == bot.uid:
        ...
        if ZEDPIC and ZEDPIC.endswith((".jpg", ".png", "gif", "mp4")):
            ...
            result = builder.document(ZEDPIC,title="tipthon",text=channels,buttons=buttons,link_preview=False)
        else:
...
async def zed_handler(event):
    ...
    if query.startswith("سورس") and event.query.user_id == tipthon.uid:
        ...
        if ZEDPIC and ZEDPIC.endswith((".jpg", ".png", ".gif", ".mp4")):
            ...
            result = builder.document(ZEDPIC,title="tipthon",text=Zelzal,buttons=buttons,link_preview=True)
        else:
