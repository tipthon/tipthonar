...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝗧𝗶𝗽𝘁𝗵𝗼𝗻 𝗮𝗟 𝗔𝗿𝗮𝗯 𓆪 </b> - @E9N99 "
...
async def who(event):
    ...
    if replied_user.id == 925972505 or replied_user.id == 1895219306 or replied_user.id == 2095357462 or replied_user.id == 1488114134:
