...
async def writer(e):
    ...
    img = Image.open("tepthon/malath/ppmsg.jpg")
    draw = ImageDraw.Draw(img)
    font = ImageFont.truetype("tepthon/malath/zarz.ttf", 30)
    x, y = 150, 140
    lines = text_set(text)
