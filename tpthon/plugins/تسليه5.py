# animation5 for tpthon edit by ~ @zlzzl77
...
@tipthon.ar_cmd(pattern=f"تتحميل$")
async def _(event):
    if event.fwd_from:
        return
...
@tipthon.ar_cmd(pattern=f"دائره$")
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@tipthon.ar_cmd(pattern=f"هاربر$")
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 2
...
@tipthon.ar_cmd(pattern=f"العد التنازلي$")
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
