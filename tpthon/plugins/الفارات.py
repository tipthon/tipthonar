...
@tipthon.ar_cmd(pattern="حذف(?:\s|$)([\s\S]*)")
async def variable(event):
    if Config.HEROKU_API_KEY is None:
        return await ed(
            event,
...
@tipthon.ar_cmd(pattern="جلب(?:\s|$)([\s\S]*)")
...
@tipthon.ar_cmd(pattern="وقت(?:\s|$)([\s\S]*)")
async def variable(event):
    if Config.HEROKU_API_KEY is None:
        return await ed(
            event,
...
@tipthon.ar_cmd(pattern="اضف صورة (الحماية|الحمايه|الفحص|الوقتي|البوت) ?(.*)")
async def _(malatha):
    if malatha.fwd_from:
        return
    if Config.HEROKU_API_KEY is None:
...
@tipthon.ar_cmd(pattern="اوامر الفارات")
