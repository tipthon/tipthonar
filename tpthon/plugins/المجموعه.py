...
CHANNELS_STR = "𓆩 𝗧𝗶𝗽𝘁𝗵𝗼𝗻 𝗮𝗟 𝗔𝗿𝗮𝗯 **- 🝢 - احصـائيـات جميـع القنـوات** 𓆪\n\n"
...
async def ban_user(chat_id, i, rights):
    try:
        await tipthon(functions.channels.EditBannedRequest(chat_id, i, rights))
        return True, None
...
@tipthon.ar_cmd(pattern="اضافه ([\s\S]*)", groups_only=True)
async def get_users(event):
    ...
    async for user in event.client.iter_participants(event.pattern_match.group(1)):
        try:
            ...
            tol = f"@{user.username}"
            lol = tol.split("`")
            await tipthon(InviteToChannelRequest(channel=event.chat_id, users=lol))
            s = s + 1
            await ZTHON.edit(
                f"**❈╎جـارِ الإضافـة . . .**\n\n**❈╎اضيف** `{s}` \n**❈╎خطـأ بـ اضافـة** `{f}` \n\n**❈╎آخـر خطـأ:** `{error}`"
            )
...
async def stats(event):  # sourcery no-metrics
    ...
    response = f"𓆩 𝗧𝗶𝗽𝘁𝗵𝗼𝗻 𝗮𝗟 𝗔𝗿𝗮𝗯 **- 🝢 - احصـائيـات {full_name}** 𓆪\n"
...
async def _(event):  # sourcery no-metrics
    ...
    async for i in event.client.iter_participants(event.chat_id):
        ...
        if i.bot:
            ...
            n += 1
    if input_str:
        required_string = """𓆰 𓆩 𝗧𝗶𝗽𝘁𝗵𝗼𝗻 𝗮𝗟 𝗔𝗿𝗮𝗯 **- 🝢 - معـلومـات المجمـوعــه** 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 
...
𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"""
        ...
        await sleep(5)
    await et.edit(
        """𓆰 𓆩 𝗧𝗶𝗽𝘁𝗵𝗼𝗻 𝗮𝗟 𝗔𝗿𝗮𝗯 **- 🝢 - معـلومـات المجمـوعــه** 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻
⪼ **العدد ↫ {} **مستخدماً
⪼ **الحسابات المحذوفه ↫** {}
⪼ **اخر ظهور منذ زمن طويل ↫** {}
⪼ **اخر ظهور منذ شهر ↫** {}
...
@tipthon.ar_cmd(pattern="رفع الحظر ?(.*)")
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
async def count(event):
    ...
    result += f"𓆩 𝗧𝗶𝗽𝘁𝗵𝗼𝗻 𝗮𝗟 𝗔𝗿𝗮𝗯 **- 🝢 - احصـائيـات الحسـاب** 𓆪\n"
