        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @M_H_N\
                                  \n\n--------بـدء تتبـع سجـل تيبثــون 𝗧𝗶𝗽𝘁𝗵𝗼𝗻--------\
            ...
            if pattern is not None:
                ...
                if edited:
                    tipthon.add_event_handler(func, events.MessageEdited(**kwargs))
                tipthon.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر خطـأ تيبثــون 𝗧𝗶𝗽𝘁𝗵𝗼𝗻 ✘**\n\n"
                        link = "[المطــور](https://t.me/M_H_N)"
            ...
            if edited is True:
                tipthon.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                tipthon.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
